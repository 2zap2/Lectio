...
- Identify the possible root causes in the code
- Test which of the possibilities cause the issues. If nothing is found, repeat from identifying possible root causes. Please continue if root cause is found.
